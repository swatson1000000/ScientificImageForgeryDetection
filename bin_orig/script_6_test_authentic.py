"""
Test Script 9 on 100 authentic training images
This will show us how the ensemble classifier performs on known authentic images
"""
...
TEST_IMAGES_PATH = os.path.join(DATASET_PATH, "test_authentic_100")
...
def main():
    ...
    print("\n" + "="*80)
    print("TEST: ENSEMBLE INFERENCE ON 100 AUTHENTIC TRAINING IMAGES")
    print("="*80)
    ...
    print("\n" + "="*80)
    print("PREDICTION ANALYSIS ON KNOWN AUTHENTIC IMAGES")
    print("="*80)
    ...
    submission_path = os.path.join(OUTPUT_PATH, 'submission_authentic_100.csv')
